...
>
> 5.1.3. Phân tích các loại câu hỏi thường gặp nhằm xác định các kịch
> bản hội thoại chính cho chatbot.
>
...
>
> 5.2.2. Phân rã yêu cầu thành các chức năng chatbot (intent, entity,
> kịch bản hội thoại).
>
...
>
> 5.4.2. Phát triển giao diện chatbot (chat widget tích hợp vào
> website).
>
> 5.4.3. Thống nhất yêu cầu và giao diện với khách hàng E-Com Global.
>
> 5.4.4. Phát triển chatbot: Xây dựng intent, entity; Huấn luyện dữ
> liệu; Tích hợp webhook gọi API tra cứu đơn hàng
>
